                    ...
                    <tr key={user.id}>
                      ...
                      <td>
                        <button
                          ...
                          className={`${
                            user.status ? style.activebtn : style.inactivebtn
                          } totalFont`}
                        >
                          {user.status ? "Active" : "InActive"}
                        </button>
                      ...
                      <td>
                        <button
                          ...
                          className={`${
                            user.toggle ? style.lockIcon : style.openlockIcon
                          } totalFont`}
                        >
                          {user.toggle ? (
              ...
              >
                ...
                <tbody>
                  {recentroles.map((role) => (
                    <tr key={role.id}>
                     <td><Link className={`${style.userlink}`} to={`/dashboard/roles/${role.id}`}>{role.name}</Link></td>
                      <td>
                        <button
                          onClick={() => handleToggleRole(role)}
                          className={`${
                            role.toggle ? style.lockIcon : style.openlockIcon
                          } totalFont`}
                        >
                          {role.toggle ? (
                            <i className="fa-solid fa-lock"></i>
