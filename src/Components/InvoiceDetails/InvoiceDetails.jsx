      ...
      <header className={styles.pageHeader}>
        ...
        <div className={styles.headerRight}>
          <button className={styles.btnOutline}>
            <FiFileText className={styles.btnIcon} /> View PDF
          </button>
          <button className={styles.btnFilled}>
            <FiDownload className={styles.btnIcon} /> Download PDF
          </button>
        </div>
      </header>
            ...
            {/* <div className={styles.referenceBlock}>
              ...
              {order ? (
                <div className={styles.refBox}>
                  <div className={styles.refBoxLeft}>
                    <div className={styles.refBoxText}>
                      <span className={styles.refBoxId}>ORD-{String(order.id).padStart(3, '0')}</span>
                      <span className={styles.refBoxSubtitle}>
                        {formatDate(order.orderDate)} &middot; {String(order.status).toLowerCase()}
                      </span>
                    </div>
                  </div>
                  <FiArrowUpRight className={styles.refArrowIcon} />
