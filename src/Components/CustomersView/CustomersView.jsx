...
export default function CustomersView() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setSubmitting, resetForm }) => {
            try {
                await api.put(
                    `/ClientSubscriptions/${customer.id}/tableau-url`,
                ...
                <header className={styles.header}>
                    <div className={styles.backSection}>
                        ...
                        <nav className={styles.breadcrumbs}>
                            <span className={styles.breadcrumbLink}>Customers</span>
                    ...
                    <div className={styles.card} style={{ alignSelf: 'start' }}>
                        ...
                        <div className={styles.activityGrid}>
                            ...
                            {/* <div className={styles.activityCard}>
                                ...
                                <div className={styles.activityText}>
                                    <span className={styles.activityCount}>{customer?.cartItems}</span>
